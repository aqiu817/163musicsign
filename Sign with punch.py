...
mail_user="sakuya@qq.com"             # Username 用户名(账号A,填写发送邮件的账号)
mail_pass="lzayoiSakuya"                  # SMTP service password. SMTP服务的口令(账号A的邮箱密码)
my_sender='sakuya@qq.com'             # 发件人邮箱账号(与账号A一致即可)
my_user='flandre@qq.com'               # 收件人邮箱账号(账号B,填写需要收件的邮件的账号)
