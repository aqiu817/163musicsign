...
mail_user="xxxxxx@qq.com"             # Username 用户名(账号A,填写发送邮件的账号)
mail_pass="xxxxxx"                  # SMTP service password. SMTP服务的口令(账号A的邮箱密码)
my_sender='xxxxxx@qq.com'             # 发件人邮箱账号(与账号A一致即可)
my_user='xxxxxx@qq.com'               # 收件人邮箱账号(账号B,填写需要收件的邮件的账号)
...
'''
uin = '账号'                                # 网易云账号
pwd = 'a8105204604a0b11e916f3879aae3b0b'    # 网易云密码
